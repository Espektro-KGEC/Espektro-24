...
// reorganise the events so that events are organised based on category and then day

const events: Record<Categories, Record<number, Array<CategoryEvent>>> = {
  Exotica: {
    0: [
      {
        name: "d0c1event1",
  ...
  Techtix: {
    0: [
      {
        name: "d0c2event1",
        description: "d0c2event1 description",
      },
      {
        name: "d0c2event2",
        description: "d0c2event2 description",
      },
      {
        name: "d0c2event3",
        description: "d0c2event3 description",
      },
      {
        name: "d0c2event4",
        description: "d0c2event4 description",
      },
    ],
    1: [
      {
  ...
  Quixine: {
    0: [
      {
        name: "d0c3event1",
        description: "d0c3event1 description",
      },
      {
        name: "d0c3event2",
        description: "d0c3event2 description",
      },
      {
        name: "d0c3event3",
        description: "d0c3event3 description",
      },
      {
        name: "d0c3event4",
        description: "d0c3event4 description",
      },
    ],
    1: [
      {
